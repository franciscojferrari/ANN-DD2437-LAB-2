...
from competitive_learning import CompetitiveLearning, find_rbf_widths
...
cl_epochs = 200
cl_rate = 0.01
cl = CompetitiveLearning(num_rbfs)
centers = cl.fit(x_train, cl_epochs, cl_rate)
widths = find_rbf_widths(centers)
